...
{\zihao{5} 林子立\quad 指導教授：余清祥\,教授}\\[3pt]
...
偏誤}（Wang et al. 2018；余清祥等 2021）。既有的小樣本研究多以量化
\textbf{不確定性}為目標（如 Chen et al. 2017 以參數式拔靴法刻畫最大概似
估計量的有限樣本分布），較少追問估計是否\textbf{系統性偏移}。
本文提出三個依序遞進的問題：
...
\begin{enumerate}[leftmargin=*]
  ...
  \item \textbf{預測區間不是更窄而是最寬。} $\LCe$ 的 2050 年 $e_0$
        ...
        「$\kappa_t$ 變異更小」並不等價。
  \item \textbf{涵蓋率的優勢建立在寬度的犧牲之上}，且六種方法的實證涵蓋率
